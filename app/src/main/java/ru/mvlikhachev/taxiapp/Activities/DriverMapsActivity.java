...
public class DriverMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void updateLocationUi() {
        ...
        if (currentLocation != null) {
            ...
            String driverUserId = FirebaseAuth.getInstance().getCurrentUser().getUid(); // Driver ID
            ...
            geoFire.setLocation(driverUserId, new GeoLocation(currentLocation.getLatitude(),
                ...
                public void onComplete(String key, DatabaseError error) {
                    Log.e("geofire", "GeoFire Complete");
                }
            });
    ...
    protected void onResume() {
        ...
        if (isLocationUpdatesActive && chackLocationPermissions()) {
            startLocationUpdates();
        } else if (!chackLocationPermissions()) {
    ...
    private void requestLocationPermission() {
        ...
        if (shouldProvideRationale) {
            showSnackBar(
                    "Location permission is needed for app" +
                            "fonctionality",
                    "Ok",
    ...
    private boolean chackLocationPermissions() {
